 ...
 */
public class MirelandsTreeClusterFeature implements Feature {
    public static final MapCodec<MirelandsTreeClusterFeature> CODEC = MapCodec.unit(MirelandsTreeClusterFeature::new);

    public MirelandsTreeClusterFeature() {}

    @Override
    public MapCodec<MirelandsTreeClusterFeature> codec() {
        return CODEC;
    }
